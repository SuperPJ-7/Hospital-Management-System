...
<input type="text" id="doc-pres-search" class="input" min="1" placeholder="Enter patient-id">
<button class="button" onclick="Search('doc-pres-search','prescription-table','../doctor/pres_search.php')">Search</button>
</div>
